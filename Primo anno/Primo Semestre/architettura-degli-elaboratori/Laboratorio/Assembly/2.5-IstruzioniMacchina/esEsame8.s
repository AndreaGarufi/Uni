...
res2       fill    4
           ...
           mov     r1,#dim ;carica in r1'indirizzo di dim
           ldr     r1,[r1] ;carica il valore
           mov     r2,#list ;mette in r2 l'indirizzo della lista

           mov     r7,#0 ; registro contatore (indica l'indice dell'array)
           mov     r8,#0 ;registro somma parziale pari
           mov     r9,#0 ;registro somma parziale dispari

ciclo      
           and     r4,r7,#1; faccio un and tra l'indice dell'array e 1, per capire se la posizione è pari o no
           cmp     r4,#0; comparo r4 con 0 per vedere se è pari o dispari (se la sottrazione con 0 viene 0 allora l'indice è pari)
           beq     addPari; salto a addPari se i 2 numeri sono uguali altrimenti...
           b       addDispari; salto a addDispari se i 2 numeri sono diversi

addPari    
           ldr     r5,[r2]; carico il valore puntato da r2 in r5 (quindi carico la lista)
