...
La codifica numerica di un'istruzione in assembly è il processo attraverso cui le istruzioni di basso livello vengono tradotte in linguaggio binario, ovvero il linguaggio che la CPU può capire. Ogni istruzione corrisponde ad una precisa sequenza di bit. Questa codifica è determinata dall'architettura del processore (CISC o RISC). Nel caso di CPU a 32 bit abbiamo 3 forme di istruzioni:
