...
È un'ottimizzazione che permette di risparmiare memoria quando processi diversi hanno delle pagine in cui, in una determinata fase, è presente lo stesso contenuto. 
