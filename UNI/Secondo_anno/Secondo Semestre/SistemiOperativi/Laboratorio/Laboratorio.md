...
Ragionando in uno scenario multi-thread, più processi potrebbero aprire lo stesso file e avere problemi di letture e scritture concorrenti, quindi nascono le funzioni *pread* e *pwrite* che sono omonime a read e write ma sono atomiche.

Può essere utile creare dei duplicati degli identificatori dei file per fare questa cosa usiamo:
