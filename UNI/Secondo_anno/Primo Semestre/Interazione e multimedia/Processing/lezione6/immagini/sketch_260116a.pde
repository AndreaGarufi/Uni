...
/*
//creazione immagine colorata usando anche lerp
PImage I;
float r,g,b;
color c;
...
/*
diagonale usando la matrice linearizzata
PImage I;
color c;
...
/*
//immagine che cambia colore usando i pixel messi in un array
PImage I;
// I.loadPixel();
// I.updatePixel();
float r,g,b;
...
void keyPressed(){
  ...
  for(int i = 0; i < I.pixels.length; i++){
    c1 = I.pixels[i];
    c = color(red(c1), green(c1)+ar, blue(c1));
    I.pixels[i] = c;
  }
...
/*
//immagine di lena e lo sfondo cambia in base a dove è il mouse sulla foto
PImage H;
color c;
int x, y;
